...
public class CasoFourAleja {
    ...
    public void ValidatePQRS() throws InterruptedException {
        ...
        name.sendKeys("Alejandra Tamayo");
        ...
        for (int i = 0; i < listTypeGestion.size(); i++) {
            ...
            if (listTypeGestion.get(i).getText().equals("Felicitación")) {
        ...
        for (int i = 0; i < listService.size(); i++) {
            ...
            if (listService.get(i).getText().equals("Curso de programación para niños y niñas")) {
        ...
        textArea.sendKeys("prueba exitosa 222222");
        Thread.sleep(1000);
